...
DESCRIPTION: CONSISTS OF ALL THE COMMOLY USED USERDEFINED FUNCTIONS
OWNERS - RAVI NAIDU (rnaidu) / Dixit Adoor (dadoor)
VERSION - 1.0 (Nov 24 2011)
AUTHORS - RAVI NAIDU (rnaidu) / DIXIT ADOOR (dadoor) / NAGARAJAN BABULAL(nbabuha)
CONTRIBUTORS - Vijeth Thamme gowda (vthamme) / Tarun K (txkx)
VERSION - 2.0 (Jan 24 2012)
VERSION - 3.0 (Mar 14 2012)
--------------------------------------------------------------------------------*/
...
/* ***************************************************************************************
 ...
 AUTHOR: Venkata Ramana Reddy
 CREATION DATE: Jan 01 2012
 *************************************************************************************** */
public class COMMON_METHODS extends INITIALIZE {
	...
	public COMMON_METHODS(WebDriver driver, String onoff) {
		...
		this.driver = driver;
		this.selenium = new WebDriverBackedSelenium(driver, GoogleURL);
	...
	public static String[] splitTestObject(String TestObject)
		...
		//new WebDriverWait(driver, 5).until(ExpectedConditions.presenceOfElementLocated(By.id("")));
//Class
		return sTemp;
	 ...
	 * @throws IOException
	 */
	public static WebElement checkElement(String objName, String objIdentifier,
		...
		case className: {
			/*
			 * try { Element = driver.findElement(By.className(Locator)); }
			 * catch (Exception e) { //Reporter.catchException(e,
			 * "Check if Element - "+objName+ " is - " +
			 * "Displayed and Enabled".toUpperCase());
			 * REPORTER.catchException(e, mName+" - "+LogEvent); }
			 */
		...
		case cssSelector: {
			/*
			 * try { Element = driver.findElement(By.cssSelector(Locator)); }
			 * catch (Exception e) { //Reporter.catchException(e,
			 * "Check if Element - "+objName+ " is - " +
			 * "Displayed and Enabled".toUpperCase());
			 * REPORTER.catchException(e, mName+" - "+LogEvent); }
		...
		case id: {
			/*
			 * try { Element = driver.findElement(By.id(Locator)); } catch
			 * (Exception e) { //Reporter.catchException(e,
			 * "Check if Element - "+objName+ " is - " +
			 * "Displayed and Enabled".toUpperCase());
			 * REPORTER.catchException(e, mName+" - "+LogEvent); }
			 */
		...
		case linkText: {
			/*
			 * try { Element = driver.findElement(By.linkText(Locator)); } catch
			 * (Exception e) { //Reporter.catchException(e,
			 * "Check if Element - "+objName+ " is - " +
			 * "Displayed and Enabled".toUpperCase());
			 * REPORTER.catchException(e, mName+" - "+LogEvent); }
		...
		case name: {
			/*
			 * try { Element = driver.findElement(By.name(Locator)); } catch
			 * (Exception e) { //Reporter.catchException(e,
			 * "Check if Element - "+objName+ " is - " +
			 * "Displayed and Enabled".toUpperCase());
			 * REPORTER.catchException(e, mName+" - "+LogEvent); }
		...
		case partialLinkText: {
			/*
			 * try { Element = driver.findElement(By.partialLinkText(Locator));
			 * } catch (Exception e) { //Reporter.catchException(e,
			 * "Check if Element - "+objName+ " is - " +
			 * "Displayed and Enabled".toUpperCase());
			 * REPORTER.catchException(e, mName+" - "+LogEvent); }
		...
		case tagName: {
			/*
			 * try { Element = driver.findElement(By.tagName(Locator)); } catch
			 * (Exception e) { //Reporter.catchException(e,
			 * "Check if Element - "+objName+ " is - " +
			 * "Displayed and Enabled".toUpperCase());
			 * REPORTER.catchException(e, mName+" - "+LogEvent); }
		...
		case xpath: {
			/*
			 * try { Element = driver.findElement(By.xpath(Locator)); } catch
			 * (Exception e) { //Reporter.catchException(e,
			 * "Check if Element - "+objName+ " is - " +
			 * "Displayed and Enabled".toUpperCase());
			 * REPORTER.catchException(e, mName+" - "+LogEvent); }
	 ...
	 * Driver and Application URL AUTHOR: Venkata Ramana Reddy Verimadugu (vverimadugu) CREATION DATE: Mar
	 * 14 2014
	 * ******************************************************************
	 * ********************
	 */
	/**
	 * @author Venkata Ramana Reddy Verimadugu
	 * @param URL
	 *            to be Launched
	 * @return
	 * @throws IOException
	 ...
	 * Xpath of object and data to enter in the edit box AUTHOR: Venkata Ramana Reddy Verimadugu
	 * (vverimadugu) CREATION DATE: Mar 14 2012
	 * **************************************
	 * ************************************************
	 */
	public static void editAField(String TestObject, String Value)
		...
		// System.out.println("sTemp[0] value is " +sTemp[0] + " and " +
		// "sTemp[1] value is " +sTemp[1] + " and " +
		// "sTemp[2] value is "+sTemp[2]);

		try {
			WebElement we = checkElement(sTemp[0], sTemp[1], sTemp[2],
					sTemp[3], methodName);
	...
	public static void editAField1(String TestObject, String Value)
			throws IOException {
		try{
		String methodName = Thread.currentThread().getStackTrace()[1]
				.getMethodName();
		REPORTER.writeLog(methodName);
		    ...
		    WebElement we= driver.findElement(By.id(TestObject));

			we.clear();
			we.sendKeys(Value);
			REPORTER.LogEvent(TestStatus.PASS, "Enter " + Value 
					+ Value + "'", "Enter " + Value + " '" + Value + "'"
					+ " - Successfull".toUpperCase(), "");
		} catch (Exception e) {

			REPORTER
					.catchException(e, Value);
	...
	public static void editPasswordField(String TestObject, String Value)
			throws IOException {
	 ...
	 * *********************************************************
	 */
	public static void clickElement(String TestObject/* , String objType */)
			throws IOException {
		String methodName = Thread.currentThread().getStackTrace()[1]
				.getMethodName();
		REPORTER.writeLog(methodName);
		...
		try {
			...
			if (highlightObj.equalsIgnoreCase("on")) {
				/*
				 * String we1 = we.toString();
				 * System.out.println("we.toString is ----------------- " +
				 * we1); if (we1.contains("link text")) { we1 =
				 * we1.replace("link text", "link"); }
				 * 
				 * 
				 * we1 = (we1.substring(we1.indexOf(">") + 1,
				 * we1.lastIndexOf("]"))).trim(); we1 = we1.replace(": ", "=");
				 * String we3 = "\"" + we2 + "\""; selenium.highlight(we1);
				 */
	...
	public static void listBoxSelect(String TestObject, String Value,
		...
		String[] sTemp = splitTestObject(TestObject);
		 select = new Select(checkElement(sTemp[0], sTemp[1], sTemp[2],
				sTemp[3], methodName));
		...
		REPORTER.catchException(e, "Unable to find the object locator for list box");
		}
	}
	...
	public static void mouseOver(String TestObject) throws IOException {
		...
		try {
			...
			DriverActions.moveToElement(
					checkElement(sTemp[0], sTemp[1], sTemp[2], sTemp[3],
	...
	public static void highlightElement_2(WebElement element) {
		for (int i = 0; i < 2; i++) {
			JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript(
	...
	public static void DragandDrop(String fromTestObject, int x, int y)
		...
		try {
			WebElement fromwe = checkElement(sTempfrom[0], sTempfrom[1],
	...
	public static String getSelectedValueFromListBox(String testObject)
		...
		String[] sTemp = splitTestObject(testObject);
		// Select select = new
		// Select(checkElement(sTemp[0],sTemp[1],sTemp[2],sTemp[3],methodName));

		try {

			WebElement droplist = checkElement(sTemp[0], sTemp[1], sTemp[2],
					sTemp[3], methodName);
	...
	public static void switchToIframe(String testObject) throws IOException {
		...
		try {
			WebElement iframeLocator = checkElement(sTemp[0], sTemp[1],
					sTemp[2], sTemp[3], methodName);
