...
public class EMAIL extends REPORTER {
	...
	public static void SendEmail(String MailFormat) throws Exception {
		...
		//String host = "mailgate.uswc.uswest.com";
		//String from = "ravi.naidu@Centurylink.com";
		//String to = "ravi.naidu@Centurylink.com";

		//String host = "mail.exchange.ku.edu";
		//String host = "mail.ku.edu";
		//String host = "SMTP.ku.edu";
		//String from = "rdnaidu_sta@ku.edu";
		//String to = "ravi.naidu@Centurylink.com";

		String host = "MAMAEXCPRD012.brighthorizons.com";
		String from = "Indernain.Singh@brighthorizons.com";
		//String from = "derek.rozycki@brighthorizons.com";
		...
		//message.setRecipients(Message.RecipientType.TO, "rnaidu3@csc.com,rxnaidu@gmail.com");
		message.setRecipients(Message.RecipientType.TO, "derek.rozycki@brighthorizons.com");
		
		//message.setRecipients(Message.RecipientType.CC, "rnaidu3@csc.com,rnaidu3@csc.com");
		//message.setRecipients(Message.RecipientType.BCC, "ashwini.ravinaidu@gmail.com,katta.ashwini@gmail.com");

		// Set the "Subject" header field.
		
		//String subject = getTestData("TD_ENV") + " - " + getTestData("TD_Script_Name") + " - Automation Test Results - " + "" +" - " + Reporter.getDateFormat("vDatetype2");
		message.setSubject("AUTOMATION TEST MAIL!!");
		
		Multipart multipart = new MimeMultipart();
		//MimeBodyPart textPart = new MimeBodyPart();
		//String text = "Ravi Naidu";
...
/*		// Create the message part 
		...
		// Fill the message
		messageBodyPart.setText("<H1>Hello</H1>");		
		...
		//attachpath = System.getProperty("user.dir") + "\\Screen_Prints\\"+ "E2E_Broken_Links_FRI_JUL_05_2013_13_50_03_PM_CDT_PASS.PNG";
		//attachpath1 = System.getProperty("user.dir") + "\\Reports\\"+ "SMB_Sat_Jul_27_2013_09_29_30_AM_CDT.html";	
