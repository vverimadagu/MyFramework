 ...
 */
public class EP_Registration_Locations_Test extends INITIALIZE {
	...
	public void EP_AddLocation_Registration() throws IOException, Exception {
	...
	public void EP_Locations_AddLocation_LocationFieldValidations(String employer) throws Exception {
		...
		// Registration
		businessComponents.EP_SignUpUser(userName, employer, "regloc");
		...
		String userName1 = ReadwritDataFromProps.props.getProperty(employer + ".regloc.userName"); 
		String password = getTestData("TD_PWD");
		
		String signInArray[]={ getTestObject("OL_1"),getTestObject("OL_2"),getTestObject("OL_3")};
		Utility.loginToBUCA(userName1, password,signInArray);*/
	...
	@Test @Parameters("client") 
	public void EP_Locations_ZipCode_AutoComlpete(String employer) throws Exception {

		String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
		System.out.println("Inside - " + methodName);
		
		// login employee portal
		String userName = ReadwritDataFromProps.props.getProperty(employer  +".regloc.userName"); 
		String password = getTestData("TD_PWD");
		...
		COMMON_METHODS.VerifyTextPresent(getTestObject("OL_129"), getTestData("TD_City_loc"), "value");

		// Verify the correct state is populated 
		COMMON_METHODS.VerifyTextPresent(getTestObject("OL_133"), getTestData("TD_State_loc"), "value");

		// Verify the correct country is populated 
		COMMON_METHODS.VerifyTextPresent(getTestObject("OL_130"), getTestData("TD_County_loc"), "value");
	...
	@Test @Parameters("client")
	public void EP_Locations_UpdateAddress(String employer) throws Exception {
		...
		// login employee portal
		userName = ReadwritDataFromProps.props.getProperty(employer + ".regloc.userName"); 
		password = getTestData("TD_PWD");
		
		String signInArray2[]={ getTestObject("OL_1"),getTestObject("OL_2"),getTestObject("OL_3")};
		Utility.loginToBUCA(userName, password,signInArray2);
		...
		COMMON_METHODS.VerifyTextPresent(getTestObject("OL_127"), "Updated Address", "value");
	...
	@Test @Parameters("client")
	public void EP_PastReservationNotAffectedByEdits(String employer) throws Exception {
	...
	@Test  @Parameters("client")
	public void EP_Locations_AddLocation_ValidationMessages(String employer) throws Exception {
	...
	@Test @Parameters("client")
	public void EP_Locations_Add_Address(String employer) throws Exception {
		...
		try {
			...
			if(weLocations.getText().contains(strAddress)){
				REPORTER.LogEvent(TestStatus.PASS, "Verify the address is added. "+ weLocations.getText() , "Address is added as follows:\n" + strAddress , "");
			}
			else{
				REPORTER.LogEvent(TestStatus.FAIL, "Verify the address is added. "+ weLocations.getText(), "Address is added as follows:\n" + strAddress , "");
			}
		}catch (Exception e) {
	...
	@Test @Parameters("client")
	public void EP_Locations_Update_Address(String employer) throws Exception {
	...
	@Test  @Parameters("client")
	public void EP_Locations_AddLocation_PetFieldValidations(String employer) throws Exception {
	...
	/*@Test @Parameters("client")
	public void EP_CareRecipient_Inactive(String employer) throws Exception {
	...
	@Test @Parameters("client")
	public void EP_CareProfile_VerifyAddressInfo(String employer) throws Exception {
	...
	@Test @Parameters("client")
	public void EP_LeadingZerosZipCode(String employer) throws Exception {
		...
		this.EP_AddLocation_Registration();
	...
	@Test @Parameters("client")
	public void EP_CareAtLocatioWithoutHome(String employer) throws Exception {
	...
	@Test @Parameters("client")
	public void EP_RemoveAPetFromALocation(String employer) throws Exception {
	...
	@Test @Parameters("client")
	public void EP_PetTypeDropdownValidation(String employer) throws Exception {
	...
	@Test @Parameters("client")
	public void EP_ValidateLocations(String employer) throws Exception {
	...
	@Test @Parameters("client")
	public void EP_CannotUpdateLocations(String employer) throws Exception {
