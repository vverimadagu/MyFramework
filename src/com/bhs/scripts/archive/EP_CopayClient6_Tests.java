...
public class EP_CopayClient6_Tests extends INITIALIZE {
	...
	*//* 
	...
	public void EP_CopaySignupUser() throws Exception {
		...
		readTestData(getDataTablePath("EP"), "TD_EP4");
		...
		//Sign Up
		businessComponents.EP_SignUpUser(83);
	...
	*//**
	...
	@Test(priority=2)
	public void EP_CopayRule_Client6_InHomeHealthyOneCR() throws Exception {
